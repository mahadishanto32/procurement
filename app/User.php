...
use App\Models\PmsModels\UsersWarehouses;
...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Warehouses::class,'users_warehouses','user_id','warehouse_id');
    }
    ...
    {
        return $this->hasMany(ProjectTask::class, 'user_id', 'id');
    }
}
