    ...
    public function showOnlineQuotationForm($proposalId,$supplierId){
        ...
        try {
            ...
            if(count((array)$modal)>0){
                return 'Already submitted your quotation!';
            }
        ...
        try {
            ...
            foreach ($request->product_id as $i=>$product_id){
                $quotationItemsInput[]=[
                    ...
                    'vat'=>0,
                    'total_price'=>$request->sub_total_price[$product_id]-$request->item_discount_amount[$product_id],
            ...
            return 'Your quotation is successfully submitted';
        }
        catch (Throwable $th){
            DB::rollback();
            return $th->getMessage();
