...
class Department extends Model
{
    ...
    /**
     * Get all of the Deliverables that are assigned this department.
     */
    public function tasks()
    {
        return $this->morphedByMany(ProjectTask::class, 'alignable');
    }

    /**
     * Get all of the Sub Deliverables that are assigned this department.
     */
    public function subDeliverables()
    {
        return $this->morphedByMany(SubDeliverables::class, 'alignable');
    }

    public function projects()
    {
        return $this->morphedByMany(Project::class, 'alignable');
    }

    public function purchaseOrders()
    {
        return $this->hasMany(\App\Models\PmsModels\Purchase\PurchaseOrderRequisition::class, 'as_department_id', 'as_department_id');
    }
}
