...
namespace App\Models\PmsModels\Accounts\Menu;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;

class AccountsMenu extends Model
{
    use SoftDeletes;
    ...
    public function activeSubMenu(){
        return $this->hasMany(AccountsSubMenu::class,'menu_id','id')->orderBy('serial_num','ASC')->where(['status'=>AccountsMenu::ACTIVE,]);
    }

    public function subMenu(){
        return $this->hasMany(AccountsSubMenu::class,'menu_id','id')->orderBy('serial_num','ASC');
    }
