...
class AccountsSubMenu extends Model
{
    use SoftDeletes;
    ...
    protected $table='accounts_sub_menus';
    ...
    public function activeSubSubMenu(){
        return $this->hasMany(AccountsSubSubMenu::class,'sub_menu_id','id')->orderBy('serial_num','ASC')
            ->where(['status'=>AccountsSubSubMenu::ACTIVE,]);;
    }
    ...
    public function menu(){
        return $this->belongsTo(ProjectMenu::class,'menu_id','id');
    }
