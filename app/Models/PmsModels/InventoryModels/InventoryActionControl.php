...
class InventoryActionControl extends Model
{
    ...
    public function storeInventoryDetails()
    {
        ...
        $detail->hr_unit_id = isset(auth()->user()->employee->as_unit_id)?auth()->user()->employee->as_unit_id:null;
    ...
    public function storeInventoryLog()
    {
        ...
        $log->hr_unit_id = isset(auth()->user()->employee->as_unit_id)?auth()->user()->employee->as_unit_id:null;
