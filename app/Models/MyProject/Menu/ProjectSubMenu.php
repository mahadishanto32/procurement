...
namespace App\Models\MyProject\Menu;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;

class ProjectSubMenu extends Model
{
    use SoftDeletes;
    ...
    protected $table='project_sub_menus';
    ...
    public function activeSubSubMenu(){
        return $this->hasMany(ProjectSubSubMenu::class,'sub_menu_id','id')->orderBy('serial_num','ASC')
            ->where(['status'=>ProjectSubSubMenu::ACTIVE,]);;
    }
