...
class ProjectMenu extends Model
{
    ...
    public function activeSubMenu(){
        return $this->hasMany(ProjectSubMenu::class,'menu_id','id')->orderBy('serial_num','ASC')->where(['status'=>ProjectMenu::ACTIVE,]);
    }

    public function subMenu(){
        return $this->hasMany(ProjectSubMenu::class,'menu_id','id')->orderBy('serial_num','ASC');
    }
