                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($grn->relGoodsReceivedItems->where('quality_ensure','return')->sum('qty')-$grn->relGoodsReceivedItems->where('quality_ensure','return')->sum('received_qty')); ?></td>
                                        <td class="capitalize"><?php echo e($grn->received_status); ?></td>
                                        <td>
                                            <?php if($returned > 0): ?>
                                                <a href="<?php echo e(route('pms.quality.ensure.return.single.list',$grn->id)); ?>" class="btn btn-xs btn-info"><?php echo e(__('Items')); ?> (<?php echo e($returnedCcount); ?>)</a>
                                                <a target="__blank" href="<?php echo e(route('pms.quality.return.item.print',['id'=>$grn->id,'type'=>'return'])); ?>" class="btn btn-xs btn-warning" title="Return List"><i class="las la-print"></i></a>
                                            <?php endif; ?>
                                            
                                            <?php if($approved > 0): ?>
                                                <a target="__blank" href="<?php echo e(route('pms.quality.return.item.print',['id'=>$grn->id,'type'=>'return-approved-list'])); ?>" class="btn btn-xs btn-success" title="Return Approved List"><i class="las la-print"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pms.backend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\procurement.zbridea.com\resources\views/pms/backend/pages/quality/return-index.blade.php ENDPATH**/ ?>