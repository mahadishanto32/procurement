                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="<?php echo e($po->relGoodReceiveNote->count()); ?>">
                                        <a href="javascript:void(0)" class="btn btn-link showQCEPODetails" data-src="<?php echo e(route('pms.purchase.order-list.show',$values->relPurchaseOrder->id)); ?>" data-title="Purchase Order Details"><?php echo e($values->relPurchaseOrder->reference_no); ?>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-link showQCEPODetails" data-src="<?php echo e(route('pms.grn.grn-process.show',$values->id)); ?>" data-title="Gate-In Details"><?php echo e($values->reference_no); ?>
                                    ...
                                    <td>
                                    <?php if($values->relGoodsReceivedItems()->whereHas('relGoodsReceivedItemStockIn', function($query){
                                        return $query->where('is_grn_complete','no')->where('received_qty','>', 0);
                                    })->count()>0): ?>
                                        <a href="<?php echo e(route('pms.grn.stock.in.list',$values->id)); ?>" class="btn btn-success btn-sm">GRN</a>
                                    <?php endif; ?>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pms.backend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\procurement.zbridea.com\resources\views/pms/backend/pages/grn-stock-in/qce-list.blade.php ENDPATH**/ ?>