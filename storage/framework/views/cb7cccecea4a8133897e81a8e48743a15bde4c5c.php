                                ...
                                <td class="text-center action">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if($requisition->status==0 || $requisition->status==2 || $requisition->status==3): ?>
                                            <li><a href="<?php echo e(route('pms.requisition.requisition.edit',$requisition->id)); ?>" title="Click Here To Edit"><i class="la la-edit"></i><?php echo e(__('Edit')); ?></a>
                                            </li>
                                            <?php if($requisition->status==3): ?>
                                            <li><a href="javascript:void(0)" class="sendRequisition" data-id="<?php echo e($requisition->id); ?>" data-status="0" title="Click Here To Send"><i class="la la-paper-plane"></i> <?php echo e(__('Send')); ?></a>
                                            </li>
                                            <?php endif; ?>
                                            <?php endif; ?>
...
<?php echo $__env->make('pms.backend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/34b/a/a55a29c214/procurement.zbridea.com/resources/views/pms/backend/pages/requisitions/index.blade.php ENDPATH**/ ?>