						...
						<div class="row">
							...
							<div class="col-md-2 col-sm-6">
								...
								<div class="input-group input-group-md">
									<a href="javascript:void(0)" class="btn btn-success rounded mt-8" data-src="<?php echo e(route('pms.store-manage.store-requistion-search')); ?>" id="searchStoreRequisitonBtn"> <i class="las la-search"></i>Search</a>
								</div>
							</div>
						...
						<div id="viewResult">
							<table class="table table-striped table-bordered table-head datatable-exportable" id="dataTable" data-table-name="<?php echo e($title); ?>" border="1">
								...
								<tbody>
									...
									?>
									<?php if(count($requistionData)>0): ?>
									<?php $__currentLoopData = $requistionData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php
										$total_approved_qty += $values->items->sum('qty');
									?>
							...
							<div class="row">
								<div class="py-2 col-md-12">
									<div class="pull-right">
										<?php if(count($requistionData)>0): ?>
										<ul>
											<?php echo e($requistionData->links()); ?>
...
<script>
	...
	$('#department_id').on('change', function () {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo e(route('pms.store-manage.department.wise.employee')); ?>',
					dataType: "json",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pms.backend.layouts.master-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/34b/a/a55a29c214/procurement.zbridea.com/resources/views/pms/backend/pages/store/store-requisition-list-view.blade.php ENDPATH**/ ?>