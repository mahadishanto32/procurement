										...
										<div class="table-responsive">
											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<?php $__currentLoopData = $returned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php
													...
													<tr id="removeApprovedRow<?php echo e($item->id); ?>">
														...
														<td><?php echo e($item->relGoodsReceivedItems->unit_amount); ?></td>
														...
														<td><?php echo e(number_format($item->relGoodsReceivedItems->unit_amount*($item->return_qty),2)); ?></td>
													</tr>
													...
													<tr>
														...
														<td colspan=""><?php echo e(isset($returned)?number_format($sumOfSubtotal,2):0); ?></td>
													</tr>
													<tr>
...
</html><?php /**PATH D:\xampp\htdocs\procurement.zbridea.com\resources\views/pms/backend/pages/quality/return-item-print-view.blade.php ENDPATH**/ ?>