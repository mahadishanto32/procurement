           ...
           <ul class="navbar-nav ml-auto navbar-list">
            ...
            <li class="nav-item dropdown">
              <a href="#" class="search-toggle iq-waves-effect">
                 ...
                 <small class="badge  badge-light float-right pt-1 notification-count"><?php echo e(unreadNotification()->count()); ?></small>
              </a>
                         ...
                         <a href="#" class="iq-sub-card" id="read<?php echo e($data->id); ?>">
                            <div class="media align-items-center">
                               <div class="media-body ml-3">
                                  <h6 class="mb-0" style="color:#0db5c8" data-notification-id="<?php echo e($data->id); ?>"><?php echo $data->messages; ?></h6>
                                  
                                  <small class="float-right font-size-12"><?php echo e(date('jS F g:i a', strtotime($data->created_at))); ?></small>
                               </div>
                            </div>
                         </a>
        ...
        <li>
           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
              ...
              <div class="caption">
                 ...
                 <span class="font-size-12"><?php echo e(isset(auth()->user()->employee->unit->hr_unit_short_name)?auth()->user()->employee->unit->hr_unit_short_name:''); ?> &nbsp;|&nbsp;<?php echo e(isset(auth()->user()->employee->department->hr_department_name)?auth()->user()->employee->department->hr_department_name:''); ?></span>
              </div>
           </a>
...
<?php /**PATH /home/sites/34b/a/a55a29c214/procurement.zbridea.com/resources/views/pms/backend/menus/header-menu.blade.php ENDPATH**/ ?>