                    ...
                    @method('PUT')
                        <div class="row pr-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="number" name="number" id="number" value="{{ old('number', $entry->number) }}" class="form-control rounded">
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="entries">
                                        ...
                                        <tr>
                                                    ...
                                                    @if(isset($companies[0]))
                                                        ...
                                                        <optgroup label="[{{$company->code}}] {{$company->name}}">
                                                            @foreach($company->costCentres as $key => $costCentre)
                                                                <option value="{{$costCentre->id}}"  data-company-id="{{$costCentre->company_id}}" {{ $item->cost_centre_id == $costCentre->id ? 'selected' : '' }}>&nbsp;&nbsp;[{{$costCentre->code}}] {{$costCentre->name}}</option>
                                                            @endforeach
                                                        </optgroup>
                                                        @endforeach
                                                    @endif
                                            ...
                                            <td>
                                                <select name="chart_of_account_id[]" class="form-control chart_of_account_id select2" onchange="Entries()">{!! chartOfAccountsOptions([], $item->chart_of_account_id) !!}</select>
                                            </td>
                                            <td>
                                                <input type="number" name="amount[]" class="form-control debit text-right" @if($item->debit_credit == "D") value="{{ $item->amount }}" @else readonly @endif onchange="Entries()" onkeyup="Entries()">
                                            </td>
                                            <td>
                                                <input type="number" name="amount[]" class="form-control credit text-right" @if($item->debit_credit == "C") value="{{ $item->amount }}" @else readonly @endif onchange="Entries()" onkeyup="Entries()">
                                            </td>
                                            <td>
