               ...
               <div id="accordion">
                  <div class="card">
                    ...
                    <div id="filter" class="collapse {{ !request()->has('from') ? 'show' : '' }}" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                        <form action="{{ url('accounting/balance-sheet') }}" method="get" accept-charset="utf-8" id="filter-form">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6 pt-4">
                                    @include('accounting.backend.pages.reports.buttons', [
                                        'url' => url('accounting/balance-sheet?from='.request()->get('from').'&to='.request()->get('to')),
                                        'title' => $title
                                    ])
                                </div>
                            </div>
