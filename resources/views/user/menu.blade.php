...
@endphp
   <nav class="iq-sidebar-menu">
      <ul id="iq-sidebar-toggle" class="iq-menu">
         ...
         <li class="@if($segment1 == '') active @endif">
            <a target="__blank" href="{{ route('my_project.my-project.index') }}" class="iq-waves-effect"><i class="las la-list"></i><span>{{ __('My Project') }}</span></a>
         </li>
         <li class="@if($segment1 == '') active @endif">
            <a target="__blank" href="{{ url('accounting') }}" class="iq-waves-effect"><i class="las la-list"></i><span>{{ __('Accounting') }}</span></a>
         </li>
