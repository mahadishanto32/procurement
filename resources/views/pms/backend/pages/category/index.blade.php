                    ...
                    <table class="table table-bordered datatable-exportable" cellspacing="0" width="100%" id="dataTable" data-table-name="{{ $title }}">
                        ...
                        <tbody>
                            ...
                            <tr id="set{{ $category->id }}">
                                ...
                                <td width="10%">{{ $category->name }}</a></td>
                                {{-- <td width="15%">
                                    @foreach($category->subCategory as $subCategory)
                                        <span class="m-1 badge badge-primary">{{ $subCategory->name }}</span>
                                    @endforeach
                                </td> --}}
                                <td>
                                ...
                                <td width="10%" class="text-center">
                                    <a href="javascript:void(0)" data-role="put" data-src="{{ route('pms.product-management.category.show', $category->id) }}" class="btn btn-info m-1 btn-xs editBtn"><i class="las la-edit"></i></a>
