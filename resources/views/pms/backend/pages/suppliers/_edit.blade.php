        ...
        <div class="">
            <div class="panel panel-info">
                <div class="panel-body">
                    <form method="POST" action="{{ route('pms.supplier.update',$supplier->id) }}">
                        {{ csrf_field() }}
                        @method('PUT')
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="name" id="name" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier Name')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('name',$supplier->name) }}">
                                </div>
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="tel" name="phone" id="phone" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier Phone')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('phone',$supplier->phone) }}">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="tel" name="mobile_no" id="mobile_no" class="form-control rounded" aria-label="Large" placeholder="{{__('Ex: 88017********')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('mobile_no',$supplier->mobile_no) }}">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="email" name="email" id="email" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier Email')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('email',$supplier->email) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="zipcode" id="zipcode" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier zipcode')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('zipcode',$supplier->zipcode) }}">
                                </div>
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="city" id="city" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier City')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('city',$supplier->city) }}">
                                </div>
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="state" id="state" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier state')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('state',$supplier->state) }}">
                                </div>
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="text" name="country" id="country" class="form-control rounded" aria-label="Large" placeholder="{{__('Supplier country')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('country',$supplier->country) }}">
                                </div>
                                ...
                                <div class="form-group form-group-lg mb-3 d-">
                                    <textarea name="address" id="address" class="form-control rounded" rows="3" placeholder="{{__('Supplier Address')}}">{!! old('address',$supplier->address) !!}</textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-md mb-12 d-">
                                                ...
                                                <input type="number" name="payment_percent[]" value="{{$relPaymentTerm->payment_percent}}" id="paymentPercent_e{{$relPaymentTerm->id}}" class="form-control" min="1" placeholder="%" onkeypress="if(this.value.length==2) return false;" required />
                                            </div>
                                        </td>
                                        <td>

                                            <div class="input-group input-group-md mb-12 d-">
                                                <input type="number" name="day_duration[]" value="{{$relPaymentTerm->day_duration}}" id="dayDuration_e{{$relPaymentTerm->id}}" class="form-control" min="1" placeholder="Day" onkeypress="if(this.value.length==3) return false;" required />
                                            </div>
                        ...
                        <hr>
                        <button type="submit" class="btn btn-primary rounded" >{{ __('Update Supplier') }}</button>
