            ...
            <form action="{{route('pms.quality.ensure.status.save')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group browsers">
                        <label for="faq_id">Select Return Reason :</label>
                        <ul>
                            @if(isset($faqs))
                            @foreach($faqs as $data)
                            <li>
                                <input class="form-check-input" type="checkbox" name="faq_id[]" id="faq_{{$data->id}}" value="{{$data->id}}" required>
                                <label class="form-check-label" for="faq_{{$data->id}}"><strong>{{$data->name}}</strong>
                                </label>
                            </li>
                            @endforeach
                            @endif
