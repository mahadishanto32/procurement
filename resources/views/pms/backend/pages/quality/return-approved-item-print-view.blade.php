											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr id="removeApprovedRow{{$item->id}}">
														...
														<td>{{$item->relGoodsReceivedItems->qty-$item->received_qty}}</td>
														<td>{{number_format($item->unit_amount*$item->received_qty,2)}}</td>
													</tr>
													@endforeach
													<tr>
														<td colspan="3" class="text-right">Total</td>
														<td colspan="">{{isset($approved)?number_format($approved->sum('unit_amount'),2):0}}</td>
														...
														<td colspan="">{{isset($approved)?number_format($sumOfSubtotal,2):0}}</td>
													</tr>
													<tr>
