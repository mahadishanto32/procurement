                            ...
                            <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                                ...
                                @forelse($allData as $data)
                                    <tr>
                                        ...
                                        <td><a href="{{route('pms.acl.menu.edit',$data->id)}}"><i class="{{$data->icon_class}}"></i> {{$data->name}}</a></td>
                                        ...
                                        <td><a href="{{route('pms.acl.sub-menu.show',$data->id)}}" class="btn btn-primary btn-sm" style="color: #fff;">Sub Menu ({{$data->subMenu->count('id')}})</a></td>

                                        <td><i class="{{($data->status==App\Models\PmsModels\Menu\Menu::ACTIVE)? 'fa fa-check-circle text-success' : 'fa fa-times-circle'}}"></i></td>

                                        <td>{{$data->created_at}}</td>
                                        <td>
                                            {!! Form::open(array('route' => ['pms.acl.menu.destroy',$data->id],'method'=>'DELETE','id'=>"deleteForm$data->id")) !!}
                                            <a href="{{route('pms.acl.menu.edit',$data->id)}}" class="btn btn-success btn-sm"><i class="la la-pencil-square"></i> </a>
