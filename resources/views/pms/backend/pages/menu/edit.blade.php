            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="top-nav-btn">
                        <a href="{{route('pms.acl.menu.index')}}" class="btn btn-sm btn-primary text-white" data-toggle="tooltip" title=" Go to Menu List"> <i class="las la-list"></i>Menu List</a>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="">
                    <div class="panel panel-info">
                        <div class="panel-body">
                            {!! Form::open(array('route' => ['pms.acl.menu.update',$data->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            {!! Form::select('slug[]', $permissions,json_decode($data->slug), array('id'=>'slug','class' => 'form-control kt-select2','multiple'=>true,'required'=>true)) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            @can('menu')
                                                <a href="{{route('pms.acl.menu.index')}}" class="btn btn-secondary pull-right "> Cancel </a>
                                            @endcan
                                        </div>
                                    </div>
