            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="top-nav-btn">
                        <a href="{{route('pms.acl.sub-menu.show',$data->menu_id)}}" class="btn btn-sm btn-primary text-white" data-toggle="tooltip" title=" Go to Main Menu List"> <i class="las la-list"></i>Submenu List</a>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="">
                    <div class="panel panel-info">
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('route' => ['pms.acl.sub-menu.update',$data->id],'method'=>'PUT','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
