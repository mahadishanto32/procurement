            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="input-group input-group-md mb-3 d-">
                        <input type="number" min="1" onkeypress="if(this.value.length==9) return false;" name="min_amount" id="minAmount" class="form-control rounded" aria-label="Large" placeholder="{{__('Start from ')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('min_amount') }}">
                    ...
                    <div class="input-group input-group-md mb-3 d-">
                        <input type="number" min="1" onkeypress="if(this.value.length==9) return false;"  name="max_amount" id="maxAmount" class="form-control rounded" aria-label="Large" placeholder="{{__('End to')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('max_amount') }}">
