                    ...
                    <table class="table table-striped table-bordered table-head datatable-exportable" id="dataTable" data-table-name="{{ $title }}" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                data-src="{{route('pms.requisition.list.view.show',$values->relRequisitionDelivery->relRequisition->id)}}"  class="btn btn-link requisition m-1 rounded showRequistionDetails">{{ $values->relRequisitionDelivery->relRequisition->reference_no }}</a></td>
                                <td>
