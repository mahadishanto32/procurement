                            ...
                            <table  id="dataTable" class="table table-striped table-bordered table-head" border="1">
                                ...
                                @forelse($paymentTerms as $key=>$paymentTerm)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$paymentTerm->percentage}}%</td>
                                        <td class="text-center">{{$paymentTerm->days}}</td>
                                        <td class="text-center">{{ucwords($paymentTerm->type)}}</td>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="days" required class="form-control rounded" name="days" type="number" min="1" max="9999" value="{{ old('days', 1) }}">
                        </div>
                    </div>
                    ...
                    {{--</div>--}}
                     ...
                     <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('type',$type,old('type'),['id'=>'type', 'required'=>true,'class'=>'form-control rounded','style'=>'width:100%']) !!}
                        </div>
                        <div class="col-md-6">
