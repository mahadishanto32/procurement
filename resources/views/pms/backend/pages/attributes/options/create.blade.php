        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="top-nav-btn">
                    <a href="{{ url('pms/product-management/attribute-options?attribute_id='.request()->query('attribute_id')) }}" class="btn btn-danger btn-sm"><i class="las la-arrow-left"></i> Back</a>
                </li>
            </ul>
        </div>
        ...
        <div class="page-content">
            <div class="panel panel-info mt-3">
                <div class="panel-boby p-3">
                    <form action="{{ route('pms.product-management.attribute-options.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <a class="btn btn-dark btn-md" href="{{ url('pms/product-management/attribute-options?attribute_id='.request()->get('attribute_id')) }}"><i class="la la-times"></i>&nbsp;Cancel</a>
