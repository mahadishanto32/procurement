...
<form action="{{ route('pms.product-management.attributes.update', $attribute->id) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
@csrf
@method('PUT')
    <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            <label for="searchable"><strong>{{ __('Searchable ?') }}</strong></label>
