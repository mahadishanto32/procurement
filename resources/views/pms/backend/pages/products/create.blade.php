                ...
                <div class="panel-boby p-3">
                    ...
                    {{-- <nav>
                      <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link disabled" id="nav-attributes-tab" data-toggle="tab" href="#nav-attributes" role="tab" aria-controls="nav-attributes" aria-selected="false">Attributes</a>
                      </div>
                    </nav> --}}

                    {{-- <div class="tab-content" id="nav-tabContent">
                      <div class="tab-pane fade show active" id="nav-basic" role="tabpanel" aria-labelledby="nav-basic-tab"> --}}
                        <form action="{{ route('pms.product-management.product.store') }}" method="post">
                        @csrf
                            <div class="form-row">
                                <div class="col-md-2">
                                ...
                                {{-- <div class="col-md-3">
                                   ...
                                   <div class="col-md-3">
                                    ...
                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                        <input type="number" name="buffer_inventory" id="bufferInventory" class="form-control rounded" aria-label="Large" placeholder="{{__('Safety Stock Limit')}}" aria-describedby="inputGroup-sizing-sm" value="{{ old('buffer_inventory') }}">
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="btn btn-success rounded"><i class="la la-save"></i>&nbsp;{{ __('Save Product') }}</button>
                        </form>
                      {{-- </div>
                    </div> --}}
                </div>
