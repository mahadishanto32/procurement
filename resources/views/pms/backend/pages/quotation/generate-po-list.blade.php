                        ...
                        <table class="table table-striped table-bordered table-head" cellspacing="0" width="100%" id="dataTable">
                            ...
                            <tr id="removeRow{{$values->id}}">
                                ...
                                <td class="text-center action">
                                    ...
                                    @can('quotation-halt')
                                    <a href="{{route('pms.quotation.quotations.cs.compare.view',['id'=>$values->relRequestProposal->id,'slug'=>'grid'])}}"  title="Compare Process Analysis"  class="btn btn-success"><i class="las la-border-all"></i></a>

                                    <a href="{{route('pms.quotation.quotations.cs.compare.view',['id'=>$values->relRequestProposal->id,'slug'=>'list'])}}"  title="Compare Process Analysis"  class="btn btn-success"><i class="las la-list"></i></a>
                                    @endcan
                                </td>
                            </tr>
                            @endforeach
