                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center action">
                                     ...
                                     <a href="{{route('pms.quotation.quotations.cs.compare.view',['id'=>$values->request_proposal_id,'slug'=>'grid'])}}"  title="Compare Process Analysis"  class="btn btn-success"><i class="las la-border-all"></i></a>

                                        <a href="{{route('pms.quotation.quotations.cs.compare.view',['id'=>$values->request_proposal_id,'slug'=>'list'])}}"  title="Compare Process Analysis"  class="btn btn-success"><i class="las la-list"></i></a>
