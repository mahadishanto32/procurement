                        ...
                        <tbody id="viewResult">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('pms.grn.grn-process.index')}}{{'?po_id='.$values->id}}" target="_blank" class="btn btn-xs btn-success" data-toggle="tooltip" title="Click here to Grn List" > Gate-In({{$values->relGoodReceiveNote->count()}}) </a>
