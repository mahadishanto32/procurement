                ...
                <div class="panel panel-info">
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                {!! Form::select('as_unit_id', $units, array('id'=>'','class' => 'form-control','multiple'=>false,'required'=>true)) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                {!! Form::select('as_department_id', $departments, array('id'=>'','class' => 'form-control','multiple'=>false,'required'=>true)) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                {!! Form::select('as_designation_id', $designations, array('id'=>'','class' => 'form-control','multiple'=>false,'required'=>true)) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                {!! Form::select('warehouse_id[]', $warehouse,[], array('id'=>'','class' => 'form-control','multiple'=>true)) !!}
