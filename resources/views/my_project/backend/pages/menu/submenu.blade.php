            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="top-nav-btn">
                        <a href="{{route('pms.admin.project-menu.index')}}" class="btn btn-sm btn-primary text-white" data-toggle="tooltip" title=" Go to Main Menu List"> <i class="las la-list"></i>Main Menu</a>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="">
                    <div class="panel panel-info">
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('route' => 'pms.admin.project-sub-menu.store','method'=>'POST','class'=>'kt-form kt-form--label-right','files'=>true)) !!}
                                    ...
                                    <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                                        ...
                                        @forelse($allData as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! Form::open(array('route' => ['pms.admin.project-sub-menu.destroy',$data->id],'method'=>'DELETE','id'=>"deleteForm$data->id")) !!}
                                                    <a href="{{route('pms.admin.project-sub-menu.edit',$data->id)}}" class="btn btn-success btn-sm"><i class="la la-pencil-square"></i> </a>
