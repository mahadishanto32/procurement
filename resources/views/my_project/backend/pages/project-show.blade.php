                ...
                <div class="">
                  <div class="panel panel-info deliverableView">
                        <div class="panel-body">
                            <table class="table projectTable" border="0"
                                   cellpadding="0"
                                   cellspacing="0">
    ...
    <script>
        (function ($){
            ...
            const showCustomMenu = (position, e) => {
                ...
                let menuItemRequisition = document.createElement('div')
                menuItemRequisition.className = 'item cMRequisition p-2'
                menuItemRequisition.innerHTML = '<i class="las la-shopping-cart" style="font-size: 16px;"></i>Requisition'

                menu.appendChild(menuItemReload)
                menu.appendChild(menuItemEdit)
                menu.appendChild(menuItemRequisition)
                ...
                let requisitionBtn = document.querySelector('.cMRequisition');
                requisitionBtn.onclick = function (){
                    requisition(e.target.closest('tr'))
                };
            ...
            const requisition = () => {
                $('#contextMenu').remove();
                window.location.href = '/pms/requisition/requisition/create';
            }
