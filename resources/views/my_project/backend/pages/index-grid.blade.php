...
@section('page-css')
    <link rel="stylesheet" href="{{ asset('plugins/plugin/percircle/percircle.css') }}">
    <style>
        .container{
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="row" id="reportVariance" data-action="{{ route('my_project.status-wise-project-chart') }}">
                                ...
                                <div class="card-body container projectGrid">
                                    <div class="row">
                                        @foreach($projects as $project)
                                            <a class="col-lg-6 col-md-12 col-sm-12" href="{{ route('my_project.status', $project->id) }}">
                                                <div class="card card-info  text-center p-0 rounded">
                                                    <div class="card-header">
                                                        <p class="h5 text-dark allProjectNames" data-percent="{{ $project->status_at }}">{{ $project->name }}</p>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row text-left border border-top-0 border-left-0 border-right-0 pb-3">
                                                            <div class="col-12 text-center">{!! date('d-M-y', strtotime($project->start_date)) . '<span class="font-weight-bold h5"> to </span>'.date('d-M-y', strtotime($project->end_date)) !!}</div>
                                                        </div>
                                                        <div class="row pt-3">
                                                            <div id="{{ $project->indent_no }}" data-percent="{{ $project->status_at }}" class="projectProgress mx-auto small">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@endsection
@section('page-script')
    <script src="{{ asset('plugins/plugin/percircle/percircle.js') }}"></script>
