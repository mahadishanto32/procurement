...
class CreateProjectMenuTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_menu', function (Blueprint $table) {
            ...
            $table->string('status')->default(ProjectMenu::ACTIVE);
            $table->string('slug')->nullable();
            $table->string('menu_for')->default(ProjectMenu::ADMIN_MENU);
            $table->string('open_new_tab')->default(ProjectMenu::NO_OPEN_NEW_TAB);
